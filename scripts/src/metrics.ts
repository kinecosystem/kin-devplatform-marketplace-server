...
export function createOrder(orderType: "marketplace" | "external", offerType: "earn" | "spend" | "pay_to_user", offerId: string) {
	statsd.increment("create_order", 1, undefined, { order_type: orderType, offer_type: offerType, offer_id: offerId });
}

export function submitOrder(offerType: "earn" | "spend" | "pay_to_user", offerId: string) {
	statsd.increment("submit_order", 1, undefined, { offer_type: offerType, offer_id: offerId });
}

export function completeOrder(offerType: "earn" | "spend" | "pay_to_user", offerId: string) {
